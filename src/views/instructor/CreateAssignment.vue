        ...
        <div class="bg-bg-surface rounded-xl border border-border-base shadow-sm overflow-hidden">
          ...
          <div class="p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div class="flex flex-col gap-2 md:col-span-2">
                ...
                <input class="w-full h-12 px-4 rounded-lg border border-border-base bg-bg-surface text-text-main focus:ring-2 focus:ring-primary focus:border-primary outline-none text-base" placeholder="مثال: تحليل الخوارزميات الجزء الأول" type="text"/>
              </div>
              <div class="flex flex-col gap-2 md:col-span-2">
                ...
                <div class="border border-border-base rounded-lg overflow-hidden">
                  ...
                  <textarea class="w-full min-h-[160px] p-4 bg-bg-surface border-none focus:ring-0 text-base text-text-main placeholder:text-text-muted" placeholder="اكتب وصف الواجب والتعليمات المطلوبة هنا..."></textarea>
                </div>
              </div>
              <div class="flex flex-col gap-2">
                <label class="text-sm font-bold text-text-main">تاريخ التسليم <span class="text-red-500">*</span></label>
                <div class="relative">
                  <input class="w-full h-12 px-4 pr-12 rounded-lg border border-border-base bg-bg-surface text-text-main placeholder:text-text-muted focus:ring-2 focus:ring-primary focus:border-primary outline-none" type="date"/>
              ...
              <div class="flex flex-col gap-2">
                ...
                <div class="relative">
                  <input class="w-full h-12 px-4 pr-12 rounded-lg border border-border-base bg-bg-surface text-text-main placeholder:text-text-muted focus:ring-2 focus:ring-primary focus:border-primary outline-none" type="number" value="100"/>
          ...
          <div class="p-8 border-t border-border-base bg-bg-base/10 flex justify-between items-center">
            ...
            <div class="flex gap-4">
              <button class="px-8 h-12 rounded-lg bg-bg-surface border border-border-base text-text-main text-sm font-bold hover:bg-bg-base transition-colors">
                حفظ كمسودة
              </button>
              <button class="px-10 h-12 rounded-lg bg-primary text-white text-sm font-bold shadow-lg shadow-primary/30 hover:bg-blue-700 transition-colors flex items-center gap-2">
