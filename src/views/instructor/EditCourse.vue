   ...
   <div class="flex flex-col min-h-screen bg-bg-base text-text-main transition-colors duration-300">
      ...
      <header
         ...
         <div class="flex items-center gap-4">
            ...
            <h2 class="text-xl font-black tracking-tight hidden md:block text-text-main">تعديل الدورة</h2>
         </div>
         <div class="flex items-center gap-3">
      ...
      <div v-if="isLoading" class="flex-1 flex items-center justify-center">
         <div class="flex flex-col items-center gap-4">
            ...
            <p class="text-text-muted font-bold">جاري تحميل بيانات الدورة...</p>
         </div>
      </div>
      ...
      <div v-else-if="loadError" class="flex-1 flex items-center justify-center">
         <div class="flex flex-col items-center gap-4 text-center">
            ...
            <p class="text-text-main font-bold">حدث خطأ أثناء تحميل الدورة</p>
            <p class="text-text-muted text-sm">{{ loadError }}</p>
            <button @click="fetchCourse"
      ...
      <!-- Content -->
      <div v-else class="p-8 max-w-[800px] mx-auto w-full">
         <div class="mb-8">
            <nav class="flex items-center gap-2 text-sm text-text-muted mb-4">
               ...
               <span class="text-text-main font-semibold">تعديل الدورة</span>
            </nav>
         </div>
         ...
         <div class="space-y-6">
            <div
               ...
               <div class="flex items-center gap-3 mb-6">
                  ...
                  <h3 class="text-lg font-black text-text-main">تعديل بيانات الدورة</h3>
               </div>
               ...
               <div class="grid grid-cols-1 gap-6">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                     <div>
                        ...
                        <input v-model="form.code" type="text" dir="ltr"
                           ...
                           :class="getError('code') ? 'border-red-400' : 'border-border-base'" placeholder="CS101" />
                  ...
                  <!-- Status -->
                  <div>
                     <label class="block text-sm font-bold mb-2 text-text-main">الحالة</label>
                     <select v-model="form.status"
                        class="w-full h-12 px-4 rounded-xl border border-border-base bg-bg-surface text-text-main focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all appearance-none cursor-pointer">
                  ...
                  <div>
                     ...
                     <textarea v-model="form.description" rows="4"
                        ...
                        placeholder="وصف الدورة..."></textarea>
...
async function fetchCourse() {
   ...
   loadError.value = ''
   try {
      const { data } = await coursesApi.getCourse(route.params.id)
...
async function submitUpdate() {
   ...
   try {
      await coursesApi.updateCourse(route.params.id, { ...form })
      showToast('تم التعديل', 'تم تحديث بيانات الدورة بنجاح', 'success')
