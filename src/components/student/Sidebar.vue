<template>
  <aside
    class="w-64 flex-shrink-0 bg-bg-surface border-l border-border-base flex flex-col justify-between p-4 h-full transition-colors duration-300">
    <div class="flex flex-col gap-6">
      ...
      <RouterLink to="/student/profile"
        ...
        <div
          class="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-12 border-2 border-primary/20 group-hover:border-primary transition-colors"
        ...
        <div class="flex flex-col">
          <h1 class="text-text-main text-base font-bold leading-normal group-hover:text-primary transition-colors">أحمد
            محمد</h1>
      ...
      <nav class="flex flex-col gap-1">
        <RouterLink to="/student/dashboard" active-class="active-nav bg-primary/10 text-primary font-bold"
        ...
        <RouterLink to="/student/courses" active-class="active-nav bg-primary/10 text-primary font-bold"
          class="flex items-center gap-3 px-4 py-3 rounded-lg text-text-muted hover:bg-bg-surface-hover transition-all">
          <span class="material-symbols-outlined">school</span>
          <span class="text-sm">المقررات</span>
        </RouterLink>
        <RouterLink to="/student/assignments" active-class="active-nav bg-primary/10 text-primary font-bold"
          class="flex items-center gap-3 px-4 py-3 rounded-lg text-text-muted hover:bg-bg-surface-hover transition-all">
        ...
        <RouterLink to="/student/certificates" active-class="active-nav bg-primary/10 text-primary font-bold"
          class="flex items-center gap-3 px-4 py-3 rounded-lg text-text-muted hover:bg-bg-surface-hover transition-all">
          <span class="material-symbols-outlined">workspace_premium</span>
          <span class="text-sm">الشهادات</span>
        </RouterLink>
        <RouterLink to="/student/ai-assistant" active-class="active-nav bg-primary/10 text-primary font-bold"
          class="flex items-center gap-3 px-4 py-3 rounded-lg text-text-muted hover:bg-bg-surface-hover transition-all">
          <span class="material-symbols-outlined">smart_toy</span>
          <span class="text-sm">المساعد الذكي</span>
        </RouterLink>
        <RouterLink to="/student/profile" active-class="active-nav bg-primary/10 text-primary font-bold"
          class="flex items-center gap-3 px-4 py-3 rounded-lg text-text-muted hover:bg-bg-surface-hover transition-all">
