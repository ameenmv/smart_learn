<template>
  ...
  <Transition name="sidebar">
    <aside v-show="!isMobile || isOpen"
      :class="[
        'bg-bg-surface border-l border-border-base flex flex-col fixed h-full z-40 transition-all duration-300',
        isMobile ? 'w-72 shadow-2xl' : 'w-72'
      ]">
      <div class="p-6 flex flex-col h-full overflow-y-auto">
        <!-- Logo + Close button -->
        <div class="flex items-center gap-2 mb-8 border-b border-border-base pb-6">
        ...
        <nav class="flex flex-col gap-1 flex-1">
          <RouterLink to="/instructor/dashboard" active-class="bg-primary !text-white shadow-lg shadow-primary/20" @click="handleNavClick"
          ...
          <RouterLink to="/instructor/courses" active-class="bg-primary !text-white shadow-lg shadow-primary/20" @click="handleNavClick"
            class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-bg-base transition-all group text-text-muted">
            <span
          ...
          <RouterLink to="/instructor/lectures" active-class="bg-primary !text-white shadow-lg shadow-primary/20" @click="handleNavClick"
            class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-bg-base transition-all group text-text-muted">
            <span
          ...
          <RouterLink to="/instructor/quizzes" active-class="bg-primary !text-white shadow-lg shadow-primary/20" @click="handleNavClick"
            class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-bg-base transition-all group text-text-muted">
            <span
          ...
          <RouterLink to="/instructor/assignments" active-class="bg-primary !text-white shadow-lg shadow-primary/20" @click="handleNavClick"
            class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-bg-base transition-all group text-text-muted">
            <span
          ...
          <RouterLink to="/instructor/students" active-class="bg-primary !text-white shadow-lg shadow-primary/20" @click="handleNavClick"
            class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-bg-base transition-all group text-text-muted">
            <span
          ...
          <RouterLink to="/instructor/settings" active-class="bg-primary !text-white shadow-lg shadow-primary/20" @click="handleNavClick"
            class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-bg-base transition-all group text-text-muted">
            <span
